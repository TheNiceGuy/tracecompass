...
public enum ChartType {
     ...
     * Defines a bar chart
     */
    BAR_CHART(checkNotNull(Messages.Chart_EnumBarChart)),
    /**
     * Defines a scatter chart
     */
    SCATTER_CHART(checkNotNull(Messages.Chart_EnumScatterChart)),
    /**
     * TODO: Defines a pie chart
     */
    PIE_CHART(checkNotNull(Messages.Chart_EnumPieChart));
