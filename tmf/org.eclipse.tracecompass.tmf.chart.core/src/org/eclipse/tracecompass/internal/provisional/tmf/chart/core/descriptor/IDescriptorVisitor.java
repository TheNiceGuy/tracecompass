...
public interface IDescriptorVisitor {
     ...
     *            A string descriptor
     */
    default void visit(DataChartStringDescriptor<?> desc) {
     ...
     *            A number descriptor
     */
    default void visit(DataChartNumericalDescriptor<?, ? extends Number> desc) {
     ...
     */
    default void visit(DataChartTimestampDescriptor<?, ? extends Number> desc) {
