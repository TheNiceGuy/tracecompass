 ...
 * "understands". It uses {@link IDataResolver} for resolving data it describes
 * from an an object it understands. For example, it can be seen as a column
 * inside a table we want data from.
 *
 * @param <T>
 *            The type of object it understands
 * @param <R>
 *            The type of object it describes
 *
