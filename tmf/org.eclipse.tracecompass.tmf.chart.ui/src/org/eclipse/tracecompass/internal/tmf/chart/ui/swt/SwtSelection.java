 ...
 */
public class SwtSelection {

    // ------------------------------------------------------------------------
    // Members
    // ------------------------------------------------------------------------

    private Set<SwtPoint> fSelection = new HashSet<>();
    ...
    /**
     * This method select/unselect a point from the selected points.
     *
     * @param target
     ...
     */
    public boolean touch(SwtPoint target, boolean multiple) {
        ...
        /* Add the new point */
        SwtPoint point = new SwtPoint(target);
     ...
     *            The point to add
     */
    public void add(SwtPoint point) {
        fSelection.add(point);
    }
     ...
     */
    public Set<SwtPoint> getPoints() {
        return checkNotNull(Collections.unmodifiableSet(fSelection));
    }
