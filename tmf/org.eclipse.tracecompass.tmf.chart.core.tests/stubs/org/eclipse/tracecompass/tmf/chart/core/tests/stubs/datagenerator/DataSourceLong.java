...
/**
 * Simple implementation for generating a random source of double numbers;
 *
 * @author Gabriel-Andrew Pollo-Guilbert
 */
public class DataSourceLong extends AbstractLongSource {
    List<Double> fData;
     ...
     */
    public DataSourceLong(long size) {
        Random seed = new Random();

        fData = new ArrayList<>();
        for(int i = 0; i < size; i++) {
            fData.add(seed.nextDouble());
        }
    }
